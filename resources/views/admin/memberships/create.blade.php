...
<head>
    ...
    <title>Create Membership Plan - Admin</title>
...
<div class="max-w-4xl mx-auto p-6">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="text-gray-600 mt-1">Add a new subscription plan for your customers</p>
        </div>
    ...
    <div class="bg-white rounded-xl shadow p-6">
        <form method="POST" action="{{ route('admin.memberships.store') }}" class="space-y-6">
            @csrf
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="3" 
                          class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#506c2a] focus:border-[#506c2a]" required>{{ old('description') }}</textarea>
                @error('description')
                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="flex items-center space-x-3 pt-4">
                <button type="submit" class="btn-primary">Create Membership Plan</button>
