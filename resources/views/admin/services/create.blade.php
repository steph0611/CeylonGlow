...
<div class="gradient-bg text-white">
    <div class="max-w-6xl mx-auto px-6 py-8">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold mb-2">Add New Service</h1>
                <p class="text-blue-100">Create a new spa service for your Ceylon Glow collection</p>
            </div>
    ...
    <div class="bg-white rounded-2xl shadow-lg p-8">
        <form method="POST" action="{{ route('admin.services.store') }}" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">Upload a high-quality image of your service (JPG, PNG, GIF)</p>
            </div>
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="4" class="form-input" placeholder="Describe your service in detail..." required>{{ old('description') }}</textarea>
            ...
            <div class="flex items-center p-4 bg-gray-50 rounded-xl">
                <input type="checkbox" name="is_featured" id="is_featured" value="1" {{ old('is_featured') ? 'checked' : '' }} class="w-4 h-4 text-[#506c2a] border-gray-300 rounded focus:ring-[#506c2a]">
