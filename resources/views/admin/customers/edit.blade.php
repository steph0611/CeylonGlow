...
<head>
    ...
    <title>Ceylon Glow - Edit Customer</title>
...
<div class="gradient-bg text-white">
    <div class="max-w-7xl mx-auto px-6 py-8">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-4xl font-bold mb-2">Edit Customer</h1>
                <p class="text-blue-100">Update customer information</p>
            </div>
...
<div class="max-w-4xl mx-auto px-6 py-8">
    <div class="bg-white rounded-2xl shadow-lg p-8">
        <form method="POST" action="{{ route('admin.customers.update', $customer->_id) }}" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="border-b border-gray-200 pb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="username" name="username" value="{{ old('username', $customer->username) }}" required
            ...
            <div class="border-b border-gray-200 pb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" id="location" name="location" value="{{ old('location', $customer->location) }}"
            ...
            <div>
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500">Leave blank to keep current password. If changing, password must be at least 8 characters long.</p>
                    @error('password')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
