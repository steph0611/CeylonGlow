    ...
    <div class="relative max-w-6xl mx-auto px-6 py-12">
        <div class="flex items-center justify-between">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <h1 class="text-4xl font-bold mb-2 tracking-tight">Add New Product</h1>
                    <p class="text-blue-100 text-lg">Create a new product for your Ceylon Glow collection</p>
                </div>
            </div>
...
<div class="max-w-5xl mx-auto px-6 py-12">
    ...
    <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
        ...
        <div class="bg-white rounded-2xl shadow-xl border border-gray-100 p-8 mb-8">
            <h2 class="text-xl font-bold text-gray-800 mb-6 pb-3 border-b-2 border-gray-100 flex items-center">
            ...
            <div class="relative">
                <label class="block text-sm font-semibold text-gray-800 mb-3 tracking-wide">Upload Product Image</label>
                <div class="space-y-6">
                    <div class="border-2 border-dashed border-gray-300 rounded-xl p-8 text-center hover:border-green-500 transition-colors duration-300">
        ...
        <div class="bg-white rounded-2xl shadow-xl border border-gray-100 p-8 mb-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div class="relative">
                    ...
                    <input type="text" name="name" id="name" class="w-full px-5 py-4 border-2 border-gray-200 rounded-xl shadow-sm focus:outline-none focus:ring-4 focus:ring-green-500/20 focus:border-green-500 transition-all duration-300 bg-white hover:border-gray-300" placeholder="Enter product name" required value="{{ old('name') }}">
                </div>
                
                <div class="relative">
                    <label for="price" class="block text-sm font-semibold text-gray-800 mb-3 tracking-wide">Price ($)</label>
                    <input type="number" step="0.01" name="price" id="price" class="w-full px-5 py-4 border-2 border-gray-200 rounded-xl shadow-sm focus:outline-none focus:ring-4 focus:ring-green-500/20 focus:border-green-500 transition-all duration-300 bg-white hover:border-gray-300" placeholder="0.00" required value="{{ old('price') }}">
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div class="relative">
                    ...
                    <input type="number" name="qty" id="qty" class="w-full px-5 py-4 border-2 border-gray-200 rounded-xl shadow-sm focus:outline-none focus:ring-4 focus:ring-green-500/20 focus:border-green-500 transition-all duration-300 bg-white hover:border-gray-300" placeholder="0" required value="{{ old('qty') }}">
                </div>
                ...
                <div class="relative">
                    ...
                    <select name="category" id="category" class="w-full px-5 py-4 border-2 border-gray-200 rounded-xl shadow-sm focus:outline-none focus:ring-4 focus:ring-green-500/20 focus:border-green-500 transition-all duration-300 bg-white hover:border-gray-300">
                        ...
                        <option value="haircare" {{ old('category') == 'haircare' ? 'selected' : '' }}>Hair Care</option>
                        <option value="bodycare" {{ old('category') == 'bodycare' ? 'selected' : '' }}>Body Care</option>
